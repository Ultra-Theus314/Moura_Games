...
--
-- Host: 127.0.0.1
-- Tempo de geração: 13/09/2024 às 15:57
...
(58, 'Street Fighter 6', 'GAME', 'PSN', 'Street Fighter 6 é a mais recente adição à icônica série de jogos de luta desenvolvida pela Capcom. Lançado para PlayStation 5, PlayStation 4, Xbox Series X/S e PC, o jogo traz uma série de inovações ao clássico estilo de combate.', 'briga6.jpg', 279),
(59, 'Resident Evil Village', 'GAME', 'PSN', 'Resident Evil Village (ou Resident Evil 8), desenvolvido pela Capcom, é um emocionante jogo de survival horror e a oitava principal entrada na série. Lançado em 2021, o jogo continua a história de Ethan Winters, que agora busca sua filha sequestrada em uma misteriosa vila europeia. O cenário sombrio é repleto de monstros e criaturas aterrorizantes, incluindo a icônica Lady Dimitrescu e seus filhos. ', 'residencia do mal.jpg', 228),
...
(70, 'Luigi Mansion 2 - Dark Moon', 'GAME', 'NINTENDO', 'Luigi Mansion é um jogo de aventura e ação para o Nintendo GameCube, e também disponível em versões posteriores para outros consoles. No jogo, Luigi, o irmão de Mario, assume o papel de um caçador de fantasmas em uma mansão assombrada. Equipado com a potente Poltergust, um aspirador de fantasmas, Luigi deve capturar espíritos, resolver quebra-cabeças e enfrentar diversos desafios para resgatar Mario e explorar os mistérios da mansão. ', 'mansao.png', 23),
(71, 'Ark Survival Evolved', 'GAME', 'PC', '\"Ark: Survival Evolved\" é um jogo de sobrevivência em mundo aberto onde você acorda em uma ilha desconhecida repleta de dinossauros e criaturas primitivas. Além de enfrentar desafios naturais e hostis, como o clima e os predadores, você deve gerenciar sua fome, sede e saúde. O jogo permite a construção de bases, criação de armas e ferramentas, e a domesticação de dinossauros e outros seres, que podem ser usados para transporte, combate e agricultura.\r\n', 'arksee.jpeg', 34),
(72, 'Fortnite', 'GAME', 'PC', '\"Fortnite\" é um jogo de batalha real que combina elementos de construção e tiro em terceira pessoa. No modo Battle Royale, 100 jogadores são lançados em uma ilha e devem competir para ser o último sobrevivente, coletando armas, recursos e equipamentos enquanto a área segura vai encolhendo. A mecânica de construção permite que os jogadores erjam estruturas para defesa e vantagem estratégica, adicionando uma camada única de estratégia ao jogo.', 'fortnite.jpg', 67),
(73, 'Left 4 Dead 2', 'GAME', 'PC', '\"Left 4 Dead 2\" é um jogo de tiro cooperativo em primeira pessoa desenvolvido pela Valve. Ambientado em um apocalipse zumbi, o jogo coloca os jogadores no papel de um dos quatro sobreviventes tentando escapar de uma série de cenários infestados de mortos-vivos.\r\n\r\nO jogo é conhecido por seu sistema de inteligência artificial \"Director\", que ajusta a dificuldade e o posicionamento dos inimigos com base no desempenho dos jogadores, criando uma experiência sempre desafiadora e imprevisível. ', 'deixados.jpg', 32),
(74, 'Dragon Ball FighterZ', 'GAME', 'PC', '\"Dragon Ball FighterZ\" é um jogo de luta desenvolvido pela Arc System Works, baseado na popular série de anime \"Dragon Ball\". Lançado em 2018, o jogo destaca-se por seu visual impressionante, que emula o estilo de animação do anime, oferecendo gráficos em 2.5D de alta qualidade.\r\n\r\nNo \"Dragon Ball FighterZ\", os jogadores podem escolher entre uma vasta gama de personagens icônicos da franquia, cada um com suas habilidades e movimentos especiais. ', 'bolas.jpg', 89),
(75, 'Crysis 3', 'GAME', 'PC', '\"Crysis 3\" é um jogo de tiro em primeira pessoa desenvolvido pela Crytek e lançado em 2013. Ambientado em um futuro distópico, o jogo se passa em uma Nova York devastada e parcialmente coberta por uma vasta selva, conhecida como \"The Liberty Dome\", que foi criada por uma megacorporação chamada C.E.L.L.\r\n\r\nOs jogadores assumem o papel de Prophet, um soldado com uma poderosa armadura Nanosuit que oferece habilidades como invisibilidade e superforça.', 'crise.jpg', 67),
(76, 'The Sims 4', 'GAME', 'PC', '\"The Sims 4\" é um jogo de simulação de vida desenvolvido pela Maxis e publicado pela Electronic Arts. Lançado em 2014, é a quarta edição principal da série \"The Sims\". No jogo, os jogadores criam e gerenciam a vida de personagens (Sim) em um mundo virtual, controlando desde a construção de casas e decoração até a definição de carreiras e relacionamentos.', 'vida2.png', 207);
